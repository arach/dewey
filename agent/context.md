...
| Docs with markdown | `/agent/docs.json` |
| Prompt registry | `/agent/prompts.json` |
| Retrieval index | `/agent/context.md` |
...
- overview: /agent/raw/docs/overview.md
- quickstart: /agent/raw/docs/quickstart.md
- api: /agent/raw/docs/api.md
